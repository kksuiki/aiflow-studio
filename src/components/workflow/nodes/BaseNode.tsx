...
import { LoadingOutlined, CheckCircleOutlined, ExclamationCircleOutlined, ClockCircleOutlined, SyncOutlined } from '@ant-design/icons'
...
const BaseNode = ({ id, label, icon, children, color = '#7c3aed', width = 220 }: BaseNodeProps) => {
  ...
  const getStatusIcon = () => {
    switch (status) {
      ...
      case 'retrying':
        return <SyncOutlined spin style={{ color: 'var(--c-orange, #fa8c16)', fontSize: 13 }} />
      case 'timeout':
        return <ClockCircleOutlined style={{ color: 'var(--c-orange, #fa8c16)', fontSize: 13 }} />
      default:
        return null
    }
  }
